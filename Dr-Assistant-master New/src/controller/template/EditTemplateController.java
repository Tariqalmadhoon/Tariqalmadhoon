...
public class EditTemplateController implements Initializable {
    ...
    private void handleSaveButton(ActionEvent event) {
        ...
        templateDrug = new TemplateDrug(templateDrugList.size() + 1, tfDrugDuration.getText(), tfDrugAdvice.getText());
    ...
    private void handleUpdateButton(ActionEvent event) {
        ...
        templateDrug = new TemplateDrug(sl,tfDrugDuration.getText(), tfDrugAdvice.getText());
